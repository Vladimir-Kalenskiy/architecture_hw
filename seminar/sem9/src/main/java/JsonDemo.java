...
// Команды в терминале:
//        Invoke-WebRequest -Uri http://localhost:8080/users -Method POST  (создание юзера)
//        Invoke-WebRequest -Uri http://localhost:8080/users -Method GET   (получить юзера)
//        Invoke-WebRequest -Uri http://localhost:8080/users/1 -Method DELETE (удалить юзера)